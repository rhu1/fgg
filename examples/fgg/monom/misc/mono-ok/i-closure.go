//$ go run github.com/rhu1/fgg -fgg -monomc=tmp/test/fg/monom/misc/mono-ok/i-closure.go -v fgg/examples/monom/misc/mono-ok/i-closure.go
//$ go run github.com/rhu1/fgg -eval=-1 -v tmp/test/fg/monom/misc/mono-ok/i-closure.go
