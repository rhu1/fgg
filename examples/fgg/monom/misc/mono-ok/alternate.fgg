//$ go run github.com/rhu1/fgg -fgg -monomc=tmp/test/fg/monom/misc/mono-ok/alternate.go fgg/examples/monom/misc/mono-ok/alternate.go
//$ go run github.com/rhu1/fgg -eval=10 -v tmp/test/fg/monom/misc/mono-ok/alternate.go
