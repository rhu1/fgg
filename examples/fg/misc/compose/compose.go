//$ go run github.com/rhu1/fgg -v -eval=46 fg/examples/misc/compose/compose.go
// Cf.
//$ go run github.com/rhu1/fgg/fg/examples/misc/compose
...
func main() {
	...
	fmt.Printf("%#v", compose{incr{D{}._1()}, incr{D{}._2()}}.Apply(D{}._3()).
				(Nat). // Main example (assertion necessary) // -eval=46
				Add(Zero{}))
